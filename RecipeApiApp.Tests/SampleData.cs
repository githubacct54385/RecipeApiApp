    ...
    public class SampleData {
        public static List<Hit> SampleHits () {
            ...
            recipe.IngredientLines =
                new List<string> () { "1/2 cup olive oil", "5 cloves garlic, peeled" };

            recipe.Ingredients =
                new List<Ingredient> () {
                    new Ingredient () { Text = "1/2 cup olive oil", Weight = 108.0 },
                    new Ingredient () { Text = "5 cloves garlic, peeled", Weight = 15.0 }
                };
            recipe.Calories = 4055.76;
            recipe.TotalWeight = 2765.59;
            recipe.TotalTime = 60.0;
